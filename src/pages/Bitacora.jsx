  ...
  return (
    <>
      ...
      <section className={styles.section}>
        <h2 className={styles.h2}>Decisiones de diseño tomadas por el equipo</h2>
        <p>
      ...
      <section className={styles.section}>
        <h2 className={styles.h2}>Dificultades encontradas y cómo se resolvieron</h2>
      ...
      <section className={styles.section}>
        <h2 className={styles.h2}>Cambios importantes durante la implementación</h2>
        <ul className={styles.listaMain}>
          <li>Se incorporó un menú de navegación lateral para <strong>facilitar la usabilidad</strong></li>
